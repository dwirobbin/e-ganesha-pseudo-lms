...
return [
    'authorities' => [
        ...
        'Manajemen tahun angkatan' => [
            'Melihat tahun angkatan',
            'Menambahkan tahun angkatan',
            'Menghapus tahun angkatan'
        ],
        'Manajemen log aktifitas' => [
            'Melihat log aktifitas',
            'Menghapus log aktifitas'
        ],
        'Manajemen wewenang' => [
            'Melihat daftar wewenang',
            'Mengubah data wewenang',
            'Detail data wewenang',
            'Menghapus data wewenang'
        ],
    ],
